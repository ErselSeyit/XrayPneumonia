...
# Get a batch of images from the training dataset and display original and augmented images
for images, labels in ds_train.take(1):
    augmented_images = img_augmentation(images)
    # Display the original images
    display_images(images[:2], ["Original", "Original"])
    # Display the augmented images
    display_images(augmented_images[:2], ["Augmented", "Augmented"])
...
try:
    ...
    with open('vgg16_model_finetuned.tflite', 'wb') as f:
